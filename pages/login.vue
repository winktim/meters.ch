<template>
  <div class="mt-4 section">
    <section class="section">
      ...
      <h1 class="font-heading text-2xl text-center" v-t="'pages.login.title'"></h1>
    </section>
    ...
    <form
      ...
      @submit="login"
    >
      <label class="w-full" for="email-input" v-t="'pages.login.form.email'"></label>
      <input
      ...
      <div class="w-full pt-4 flex justify-between">
        <label class="flex-grow" for="password-input" v-t="'pages.login.form.password'"></label>
        <nuxt-link
          tabindex="1"
          to="/reset"
          class="green-link text-right pl-4"
          v-t="'pages.login.form.forgotten-password'"
        ></nuxt-link>
      </div>
      <input
        class="w-full px-4 py-2 transparent-input"
      ...
      <div class="w-full py-2 flex justify-end items-center">
        <label class="select-none" for="remember-me-input" v-t="'pages.login.form.remember-me'"></label>
